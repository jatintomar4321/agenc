...
export function ContactForm({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
      <div className={`${bgColor} ${textColor} rounded-lg p-4 sm:p-6 md:p-8 w-full max-w-[95%] sm:max-w-[80%] md:max-w-[60%] lg:max-w-md shadow-xl`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          {isEmailVerified && (
            <div className="text-green-500 text-sm font-medium">Email verified successfully!</div>
          )}
          <div>
