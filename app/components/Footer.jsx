...
const Footer = () => {
  ...
  return (
    <footer
      className={`${bgColor} ${textColor} py-6 sm:py-8 md:py-12 px-4 sm:px-6 md:px-8 lg:px-10 mx-4 my-6 sm:my-8 md:my-10 rounded-2xl sm:rounded-[2rem] md:rounded-[2.5rem] border border-gray-200/10`}
