...
export default function Hero() {
  ...
  return (
    <motion.div data-scroll data-scroll-section data-scroll-speed="-.7" 
    ...
    >
      {/* Tagline */}
      <motion.h2
        className="text-white/80 text-xl md:text-[1.6rem] mb-6"
      ...
      {/* Main Heading */}
      <motion.h1
        className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-16 max-w-4xl"
        variants={textVariants}
      >
        The new era of{' '}<br/>
        <span className="relative text-6xl md:text-6xl lg:text-7xl">
          Brand{' '}
          <motion.span
      ...
      {/* Feature Icons Grid */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-16 max-w-3xl w-full">
        {features.map((feature, index) => (
          ...
          >
            ...
            `}>
              {/* Gradient Border */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#ED1C24] via-[#F15A29] to-[#EC008C]" />
