...
export default function PricingTable() {
  ...
  return (
    <div
      className={`w-full ${bgColor} ${textColor} sm:p-8 ${
        isFormSubmitted ? "min-h-screen" : "h-auto"
      }`}
    >
      <div
        className={`max-w-[1300px] mx-auto px-4 ${
          isFormSubmitted ? "" : "h-full flex flex-col justify-center"
        }`}
      >
        {/* Title and Button */}
        <div className="text-center">
          <h2 className="text-2xl lg:text-4xl font-bold pb-6">
